...
<header>
<hgroup><h1 itemprop="headline"><?php echo $yellow->page->getHtml("titleBlog") ?></h1></hgroup>
</header>
<?php endif ?>
...
<article>
<header>
<hgroup class="entry-title"><h2 itemprop="headline"><a itemprop="url" href="<?php echo $page->getLocation(true) ?>"><?php echo $page->getHtml("title") ?></a></h2></hgroup>
